        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono-code text-xs">
            ...
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 space-y-2">
              <span className="text-amber-400 font-bold">1. RAW INGRESS PAYLOAD ({currentRaw.source})</span>
              <pre className="p-3 rounded-lg bg-slate-900 text-slate-300 text-[11px] overflow-x-auto border border-slate-800">
                {JSON.stringify(currentRaw.rawPayload, null, 2)}
              </pre>
            </div>

            {/* Normalized Unified Event */}
            <div className="p-4 rounded-xl bg-slate-950 border border-emerald-500/40 space-y-2">
              <span className="text-emerald-400 font-bold">2. NORMALIZED UNIFIED EVENT SCHEMA</span>
              <pre className="p-3 rounded-lg bg-slate-900 text-emerald-300 text-[11px] overflow-x-auto border border-slate-800">
                {JSON.stringify({
                  id: "ev_norm_94821",
                  ...
                  sourceIngress: currentRaw.source
                }, null, 2)}
              </pre>
            </div>
          </div>
